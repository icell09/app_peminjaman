...
class _PenggunaAdminState extends State<PenggunaAdmin> {
  ...
  Widget _buildUserList() {
    return StreamBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        final list =
            snapshot.data!.where((u) {
              final matchesName = u['nama'].toString().toLowerCase().contains(
  ...
  void _dialogForm({Map<String, dynamic>? user}) {
    ...
    String currentRole = roles.firstWhere(
      (e) =>
          e.toLowerCase() ==
          (user?['role']?.toString().toLowerCase() ?? "petugas"),
      orElse: () => "Petugas",
    );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _textField(
                          ...
                          obscure: true,
                          hint:
                              user != null ? "Kosongkan jika tak diubah" : null,
                        ),
                            ...
                            child: DropdownButton<String>(
                              ...
                              items:
                                  roles
                                      ...
                                      .toList(),
                              onChanged:
                                  (v) => setDialogState(() => currentRole = v!),
                            ),
                          ),
                        ),
                      ],
